   ...
   $.fn.pickList = function (options) {
      ...
      this.init = function () {
         var pickListHtml =
                 ...
                 "	<button  class='pAdd btn btn-primary' style='text-align:center;'>" + opts.add + "</button>" +
                 "  <button  class='pRemove btn btn-primary' style='text-align:center;'>" + opts.remove + "</button>" +
                 "      <button  class='pAddAll btn btn-primary' style='text-align:center;'>" + opts.addAll + "</button>" +
                 "	<button  class='pRemoveAll btn btn-primary' style='text-align:center;'>" + opts.removeAll + "</button>" +
                 " </div>" +
                 " <div>" +
